...
describe("UsersComponent", () => {
  ...
  beforeEach(() => {
   ...
   testUserService = TestBed.get(UserService);
  });
  ...
  it("should call subscribe Method", fakeAsync(() => {
    let userSpy = spyOn(testUserService, "getUsers").and.returnValue(of(testUsers));
    let subSpy =spyOn(testUserService.getUsers(),'subscribe');
    component.ngOnInit();
    tick();
    expect(userSpy).toHaveBeenCalledBefore(subSpy);
    expect(subSpy).toHaveBeenCalled();
  }));
  it("should excute in subscribe Method", fakeAsync(() => {
    component.ngOnInit();
